    ...
    <div>
      <div className="w-11/12 lg:w-2/6 mx-auto">
        <div className="bg-gray-200 h-1 flex items-center justify-between">
          <div className="w-1/3 bg-C2-B h-1 flex items-center">
            <div className="bg-C2-B h-6 w-6 rounded-full shadow flex items-center justify-center">
              <svg
          ...
          <div className="w-1/3 flex justify-between bg-C2-B h-1 items-center relative">
            <div className="absolute right-0 -mr-2">
              <div className="relative bg-white shadow-lg px-2 py-1 rounded mt-16 -mr-12">
                ...
                <p className="text-C2-B text-xs font-bold">Step 3: Payment</p>
              </div>
            </div>
            <div className="bg-C2-B h-6 w-6 rounded-full shadow flex items-center justify-center -ml-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="icon icon-tabler icon-tabler-check"
                width={18}
            ...
            <div className="bg-white h-6 w-6 rounded-full shadow flex items-center justify-center -mr-3 relative">
              <div className="h-3 w-3 bg-C2-B rounded-full" />
            </div>
          </div>
